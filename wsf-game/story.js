const STORY = {
  ...
  'scene-3-path-i': {
    ...
    text: [
      ...
      '\'Six weeks,\' he says.',
      '\'Yes.\' He nods at something internal. Then looks up, and the way he\'s looking at me has shifted — a door, fractionally further open. \'All right,\' he says.',
  ...
  'scene-3-path-ii': {
    ...
    text: [
      ...
      '\'Your argument has a weakness,\' he says.',
      '\'Tell me.\'',
      '\'You need the fallen collectively, not me specifically. Your incentive to protect me individually is lower than your framing implies.\'',
      ...
      'He looks at me for a long moment. \'That\'s an honest answer.\'',
      '\'I try to be accurate.\'',
      '\'All right. Provisionally.\'',
  ...
  'scene-4': {
    ...
    text: [
      ...
      '\'Miss Voss,\' I say.',
      '\'Miss Dawson.\' A pause containing the memory of two years ago — my assumption, from her initials on two well-regarded monographs, that M.E. Voss would be a man. I had been briefly wrong-footed. She had been briefly amused. \'I thought you might come. I didn\'t expect you to bring a primary source.\'',
  ...
  'scene-5': {
    ...
    text: [
      ...
      '\'When do we start?\'',
      '\'Tonight, if you\'re free.\' She glances at the skylight. \'I\'m free,\' she says.',
      'Then, to Blake: \'Does it have a name, whatever it is?\'',
      '\'Blake,\' he says.',
      'Vesper looks at him for a moment. \'Maren\'s notes called you something else,\' she says. \'Noctis.\'',
      'A pause. \'And I heard the other one called you Scorpio.\' Blake says nothing. Vesper nods slowly. \'Right. Three names. That\'s going to be a whole thing, isn\'t it.\'',
    ],
    choices: [
  ...
  'scene-6': {
    ...
    text: [
      ...
      '\'Mmm.\' Leo shifts to me. \'Your gift is going wrong. I can feel it from here.\' Then, over my shoulder: \'And you brought a mortal.\'',
      ...
      'Leo considers this.',
      '\'Charles Carver,\' Blake says quietly. \'He came to you. Before he died.\'',
  ...
  'scene-7': {
    ...
    text: [
      ...
      '\'I use all three,\' Cas says cheerfully. \'Depending on context.\'',
      '\'There is no context,\' Vesper says, \'in which one person needs three names.\'',
      '\'He\'s the constellation of hidden things,\' Pol says, with the equanimity of someone who has thought about this. \'The names are consistent with the theme.\' Blake says nothing. He has the expression of someone who has accepted that this is simply what happens when constellations discuss him.',
      ...
      '\'The ones you haven\'t reached?\'',
      '\'Four. One moving too fast to fix a location. One embedded deliberately — he received our contact and chose not to respond. One we\'ve reached but she hasn\'t answered. And one we can\'t locate at all — Aquarius.\'',
      '\'Pisces,\' Blake says.',
      '\'Yes.\' Cas turns a page. \'Water in every direction. She\'s content. She doesn\'t know we\'re looking.\'',
      '\'The one who chose not to respond,\' I say. \'Capricorn.\'',
      '\'Yes,\' Pol says. \'He is very settled where he is.\'',
  ...
  'scene-7-after': {
    ...
    text: [
      ...
      'Vesper looks at the apartment walls — the letters, the objects, the density of it. \'How long has this been going on?\'',
      '\'Since we fell,\' Cas says. \'We\'re Gemini. Communication is the work.\'',
      'Vesper is quiet for a moment. \'I thought the séance parlours were odd,\' she says. \'This is much odder.\'',
      'Pol looks at her with something approaching respect. \'Thank you,\' he says. \'That is exactly right.\'',
    ],
    choices: [
  ...
  'scene-7-choice-iii': {
    location: 'The twins\' apartment, Bleecker Street — continuous',
    image: 'images/scene-07.jpeg',
    text: ['\'They sent someone in the first week,\' Cas says. \'Very courteous, very certain. He said the family had been guardians of celestial beings for two hundred years.\' She pauses. \'We told him we\'d think about it.\'',
      'Pol adds, \'They haven\'t sent anyone since, which means they\'ve accepted the answer or they\'re waiting for a moment when we\'re more isolated.\' He says it with the calm of someone who has already prepared for both. I am going to like working with these two.'],
    choices: [{ label: 'Continue', next: 'interlude-1' }]
  },
  ...
  'scene-vdz-c': {
    ...
    text: [
      ...
      '\'You\'ve seen this before,\' I say. \'Not in this form.\'',
      '\'I knew it existed \u2014 the way I knew your name. I knew this document was here and that it was the reason the fall happened and that someone would have to come to this room.\'',
      '\'Someone,\' I say.',
      ...
      '\'We should copy it,\' I say. \'Maren needs \u2014\'',
      '\'Yes,\' he says. He doesn\'t move immediately. We are looking at each other in the lamplight and neither of us moves for three seconds that are longer than three seconds, and then I reach past him for Maren\'s spare notebook, and we copy the relevant sections and go back downstairs.',
  ...
  'scene-vdz-d': {
    ...
    text: [
      ...
      '\'You don\'t have to tell me tonight,\' I say.',
      'A long pause. \'I found something,\' he says. \'Something about \u2014 the terms. What was agreed and what was recorded. I need to understand the difference before I can explain it.\'',
      '\'All right.\'',
  ...
  'scene-11': {
    ...
    text: [
      ...
      'From the window, without turning: \'They\'ve gone,\' Vesper says.',
      'A beat later, still to the street: \'Also, whatever that was, it\'s about time.\'',
    ],
    choices: [
  ...
  'scene-14': {
    ...
    text: [
      ...
      '\'You\'ve known since the reception,\' I say.',
      '\'Since the reception.\'',
  ...
  'scene-18-choice-a': {
    ...
    text: [
      ...
      '\'Emilio.\'',
      '\'Hendrik.\' It isn\'t enough to stop everything. It\'s enough to slow it \u2014 enough for Maren and Blake and Cas and Pol to do what they came to do.',
